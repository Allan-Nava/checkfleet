...
func usage() {
  ...
  checkfleet insight --history F [--digest] [--forecast --threshold 90 [--min-r2 0.7]] [--anomaly [--z 3]] [--recovery] [--score] [--slo 0.999] [--window 60] [--output text|json]   # what the history implies
