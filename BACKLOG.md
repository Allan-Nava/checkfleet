...
- [ ] **CF-96 — Shell UX v3**: navigazione multi-vista (**Fleet / Dashboard / Config**), **command-palette** + keyboard shortcut (run, cerca, cambia vista, export), header sticky, empty-state curati, layout responsive. Scelte persistite in localStorage (come stack/intervallo/notify). **Chiude M25.**
