...
- [ ] **CF-107 — Workspace multi-config**: sidebar con i config scoperti (+ stack) e i recenti; click per switchare/eseguire; **rollup del worst** aggregato sul workspace. Lista persistita in localStorage; nessun cambio ai file, solo scoperta (riusa `ListStacks`/`DefaultConfigPath`).
