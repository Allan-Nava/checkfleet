...
- [ ] **CF-109 — Monitoraggio in background + menu-bar**: esecuzione periodica in background con indicatore di stato nella **menu-bar/tray** (Wails systray) colorato per worst status, notifica nativa al cambio di stato (riusa `App.Notify`/beeep) e voce "Open checkfleet". Ciclo di vita e permessi gestiti lato Go. **Chiude M27.**
