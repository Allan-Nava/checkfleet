...
- [ ] **CF-108 — Viste salvate (preset)**: nomina e salva combinazioni di stack + filtro + min-severity + group + vista corrente; chip a switch rapido; persistite in localStorage (come le impostazioni di CF-63/CF-71). Import/export del set come JSON.
