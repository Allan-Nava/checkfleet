...
- [ ] **CF-99 — Stati di caricamento / vuoto / errore**: skeleton o spinner durante `Run` e i fetch della dashboard; empty-state curati per vista (Fleet/Dashboard/Config); errori inline con azione ("Retry" / "Fix config"); stati `disabled` coerenti. Niente più schermate "morte" durante le attese.
