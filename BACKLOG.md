...
- [ ] **CF-93 — Heatmap modulo×tempo + drill-down**: binding esteso (`App.TrendByModule`) che restituisce il worst per-modulo per run dallo storico; **heatmap** modulo×run color-coded nella Dashboard, click su cella/modulo → trend di quel modulo. Binding testato.
