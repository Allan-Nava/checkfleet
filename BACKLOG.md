...
- [ ] **CF-112 — Note per finding**: annota un finding (owner + nota libera), mostrato in un badge/tooltip nella riga e nel detail drawer. Persistito insieme agli ack (stesso store, stessa chiave). Nessun segreto (solo testo operativo dell'utente).
