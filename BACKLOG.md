...
- [ ] **CF-100 — Micro-interazioni & motion**: transizioni tra viste, drawer e command-palette (slide/fade), feedback hover/focus/active sui controlli, entrata animata dei grafici; il tutto disattivato con `prefers-reduced-motion`.
