...
- [ ] **CF-94 — Grafici di latenza/metrica nel tempo**: usando CF-91, **line chart** SVG di una metrica (es. latenza `http`, giorni-a-scadenza `certs`) per target lungo lo storico, con selettore metrica/target; drawer dal finding. Binding che estrae le serie dallo storico, testato.
