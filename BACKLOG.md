...
- [ ] **CF-102 — Rifinitura Fleet & Dashboard**: tabella finding (densità, header sticky, hover, pill di status, **sparkline inline per target** dallo storico), grafici con tooltip/legende/assi più leggibili, layout responsive. Riusa `charts.js` + `App.Metrics`/`Trend`.
